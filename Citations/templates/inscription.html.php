        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-4">
                ...
                <form action="/inscription.php" method="POST">
                    ...
                    <input required type="text" class="form-control" name="lastname" id="lastname" placeholder="Aurèle">
                    ...
                    <input required type="text" class="form-control" name="firstname" id="firstname" placeholder="Marc">
